    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MbmStore.DAL.MbmStoreContext>
    {
        ...
        protected override void Seed(MbmStore.DAL.MbmStoreContext context)
        {
            ...
            var products = new List<Product>
            {
                new Book
                {
                    ProductId = 1, Title="A Hard Day's Write: The Stories Behind Every Beatles Song ",
                    Author ="Steve Turner", Price =150.00M, Publisher="It Books", Published=2005,
                    ISBN ="978-0060844097", ImageUrl="A_Hard_Days_Write.jpg", Category="Book"
                },
                new Book
                {
                    ProductId = 2, Title="With a Little Help from My Friends: The Making of Sgt. Pepper",
                    Author ="Georg Martin", Price=180.00M, Publisher="Little Brown & Co", Published=1995,
                    ISBN ="0316547832", ImageUrl="The Making of Sgt. Pepper.jpg", Category="Book"
                },

                new MusicCD
                {
                    ProductId = 3, Title="Abbey Road (Remastered)", Artist="Beatles", Price=128.00M,
                    Released =2009, Label="EMI", ImageUrl="abbey_road.jpg", Category="Music",
                ...
                new MusicCD
                {
                    ProductId = 4, Title="Revolver (Remastered)", Artist="The Beatles", Price=128.00M,
                    Released =2009, Label="EMI", ImageUrl="revolver.jpg", Category="Music",
                    Tracks =new List<Track>
                    {
                ...
                new Movie
                {
                    ProductId =5, Title="Jungle Book", Price=160.50M, ImageUrl="junglebook.jpg",
                    Director ="Jon Favreau", Category="Movie"
                },
                new Movie
                {
                    ProductId =6, Title="Gladiator", Price=49.95M, ImageUrl="gladiator.jpg",
                    Director ="Ridley Scott", Category="Movie"
                },
                new Movie
                {
                    ProductId =7, Title="Forrest Gump", Price=160.50M, ImageUrl="forrest-gump.jpg",
                    Director ="Robert Zemeckis", Category="Movie"
                }
            };
            ...
            var customers = new List<Customer>
            {
                new Customer
                {
                    CustomerId = 1, Firstname="Tina",Lastname="Petterson",
                    Address ="Irisdahlsvej 32", Zip="8200", City="Århus N"
                },
                new Customer
                {
                    CustomerId = 2, Firstname="Thomas", Lastname="Larsson",
            ...
            var invoices = new List<Invoice>
            {
                new Invoice
                {
                    InvoiceId = 1, OrderDate = new DateTime(2016, 09, 12), CustomerId = 1,
                ...
                new Invoice
                {
                    InvoiceId = 2, OrderDate = new DateTime(2016, 09, 18), CustomerId = 2,
                    OrderItems = new List<OrderItem>
                    {
            ...
            // Populate the database.
            invoices.ForEach(i => context.Invoices.AddOrUpdate(i));
            context.SaveChanges();
        }
    }
}
